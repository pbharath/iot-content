package bp.demo.iot.content.manager.config;
...
@Configuration
@PropertySource(value = {"classpath:iot-content-manager.properties"})
@EnableCassandraRepositories(
        basePackages = {"bp.demo.iot.content.manager.repository.dao"},
        cassandraTemplateRef = "IotContentSpaceCassandraTemplate")
public class CassandraConfig {

  private static final Logger logger = LoggerFactory.getLogger(CassandraConfig.class);

  private static final String CASSANDRA_HOST_PROPERTY = "bp.demo.iot.content.cassandra.host";
  private static final String CASSANDRA_PORT_PROPERTY = "bp.demo.iot.content.cassandra.port";
  private static final String CASSANDRA_KEYSPACE_PROPERTY = "bp.demo.iot.content.cassandra.keyspace";
  ...
  @Bean("IotContentSpaceCassandraTemplate")
